...
function AP() {
  return (
    <div>
      <Head>
        <title>Ancient Perception</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <Header />
      <div className='pt-10 flex mx-auto justify-center'>
        <h1 className='text-xs lg:text-3xl font-thin uppercase'>Ancient Perception</h1>
      </div>
      ...
      <div className='flex mx-auto flex-wrap md:flex-row-2 p-10 lg:flex-row-2 md:w-5/6 lg:w-full'>
        <div className='md:w-1/2  lg:w-1/2 relative'>
          <img className='px-2 mt-5' src="/../imgs/photos/collections/2/1.jpg" alt="" />
        ...
        <div className='md:w-1/2 lg:w-1/2 relative'>
          <img className='px-2 mt-5' src="/../imgs/photos/collections/2/11.jpg" alt="" />
          <div className='mx-2 absolute bottom-0 shadow-lg shadow-zinc-900 left-0 right-0 bg-black py-5'>
            <h3 className='text-center text-xs font-normal text-white'>ANCIENT PERCEPTION #11</h3>
          </div>
        </div>
        <div className='md:w-1/2 lg:w-1/2 relative'>
          <img className='px-2 mt-5' src="/../imgs/photos/collections/2/12.jpg" alt="" />
          <div className='mx-2 absolute bottom-0 shadow-lg shadow-zinc-900 left-0 right-0 bg-black py-5'>
            <h3 className='text-center text-xs font-normal text-white'>ANCIENT PERCEPTION #12</h3>
          </div>
        </div>
        <div className='md:w-1/2 lg:w-1/2 relative'>
          <img className='px-2 mt-5' src="/../imgs/photos/collections/2/13.jpg" alt="" />
          <div className='mx-2 absolute bottom-0 shadow-lg shadow-zinc-900 left-0 right-0 bg-black py-5'>
            <h3 className='text-center text-xs font-normal text-white'>ANCIENT PERCEPTION #13</h3>
          </div>
        </div>
        <div className='md:w-1/2 lg:w-1/2 relative'>
          <img className='px-2 mt-5' src="/../imgs/photos/collections/2/14.jpg" alt="" />
          <div className='mx-2 absolute bottom-0 shadow-lg shadow-zinc-900 left-0 right-0 bg-black py-5'>
            <h3 className='text-center text-xs font-normal text-white'>ANCIENT PERCEPTION #14</h3>
          </div>
        </div>
        <div className='md:w-1/2 lg:w-1/2 relative'>
          <img className='px-2 mt-5' src="/../imgs/photos/collections/2/15.jpg" alt="" />
          <div className='mx-2 absolute bottom-0 shadow-lg shadow-zinc-900 left-0 right-0 bg-black py-5'>
            <h3 className='text-center text-xs font-normal text-white'>ANCIENT PERCEPTION #15</h3>
          </div>
        </div>
